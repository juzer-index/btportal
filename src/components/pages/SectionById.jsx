...
const SectionById = (props) => {
  ...
  const getData = useCallback(async () => {
    try {
      ...
      if (data.data) {
        ...
        setMainData(data.data?.trips);
        setMainData2(data.data);
      } else {
  ...
  const addData = async (body) => {
    ...
    try {
      const apiData = await addTripInSections(body);
      if (apiData.error) {
        ...
        handleClose3();
        toast.success(
          <p className="text-white tx-16 mb-0">Success : Trip Added !</p>,
          {
            position: toast.POSITION.TOP_RIGHT,
                  ...
                  <div className="col-lg-4">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        readOnly
                        value={mainData2 && mainData2[0]?.title}
                      />
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div className="form-group">
                      <label htmlFor="">
                        Section Sub Title <span className="text-danger">*</span>{" "}
                      </label>
                      <input
                        type="text"
                        className="form-control"
                        readOnly
                        value={mainData2 && mainData2[0]?.subTitle}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-lg-2">
                    <Button
                      ...
                      onClick={handleShow3}
                    >
                      Add Trip To Sections
                    </Button>
                    <ToastContainer />

                    <Modal size="l" show={InputShow} onHide={handleClose3}>
                      <Modal.Header>
                        <Modal.Title>Add Trip To Section</Modal.Title>
                          ...
                          {mainData2 &&
                            mainData2[0]?.trips?.map((data2, i) => {
                              ...
                              return (
                                <tr>
                                  <td>{i + 1}</td>
                                  <td>{data2?.tripId?.title}</td>
                                  <td>
                                    <img
                                      src={data2?.tripId?.images[0]?.link}
                                      style={{
                                        height: "200px",
                                        width: "200px",
                                      }}
                                  ...
                                  <td>
                                    <Button
                                      ...
                                      animation="flip"
                                      onClick={() => {
                                        setDeleteTripId(data2?.tripId?._id);
                                        largemodalShow();
                                      }}
                                    >
