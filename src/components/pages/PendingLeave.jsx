...
// import { getUsers, addUser, updateUser } from "../../utils/api";
import {
  getAllLeaves,
  createLeave,
  updateLeave,
...
const PendingLeave = (props) => {
...

      {
        ...
        Cell: (props) => (
          <div style={{ textAlign: "left" }}>
            <span>
              {props.value === "pending" ? (
                <StatusButton value="Pending" bg="danger" />
              ) : (
                <StatusButton value="Approved" bg="success" />
              )}
            </span>
          </div>
        ),
  ...
  const getData = useCallback(async () => {
    ...
    try {
      ...
      const apiData = await getLeavesByStatus("pending");
      console.log(apiData);
      if (apiData.error) {
                ...
                <div className="row">
                  <div className="col-lg-2">
                    <Button
                      ...
                      variant="success"
                      animation="flip"
                      onClick={() => navigate("/admin/approvedLeave")}
                    >
                      Approved Leave
                    </Button>
                ...
                <div className="col-lg-12">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      className="form-control"
                      name="feedback"
                      placeholder="Feedback for Leave Request"
                    />
                    <input
                      type="hidden"
