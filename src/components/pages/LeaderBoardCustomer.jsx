...
const COLUMN = [
  ...
  },
  {
    ...
    Cell: (props) => (
      <div style={{ textAlign: "left" }} className="text-left float-left">
        {/* <Link
...
const LeaderBoardCustomer = () => {
  ...
  const getData = useCallback(async () => {
    setLoading(true);
    try {
      const apiData = await getCustomerLeaderBoard();
      if (apiData.error) {
...
export default LeaderBoardCustomer;
