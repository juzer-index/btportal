...
const Jobs = (props) => {
  ...
  const COLUMN = useMemo(
    () => [
      ...
      headersColumn("Sub Title", "subTitle"),
      headersColumn("type", "type"),
      headersColumn("Location", "location"),

      //     headersColumn("Image", "image"),
      //     {
      //       Header: "Image",
      //       accessor: "image",
      //       className: "text-center wd-15p border-bottom-0",
      ...
      //       Cell: (props) => <div style={{textAlign:"left"}}> <img width="50px" height="50px" src={props.value} alt={props.value} /></div>,
      //     },
      //     {
      //       Header: "Description",
      ...
      //       Cell: (props) => <div style={{textAlign:"left"}}> {props.value?.substring(0,50)}...</div>,
      //     },
      //     {
      //       Header: "Active",
      //       accessor: "isActive",
      ...
      //       Cell: (props) =>  <div style={{textAlign:"left"}}><span>{props.value ? "YES" : "NO"}</span></div>,
      //     },
      {
        Header: "Actions",
        accessor: "invoice",
  ...
  const addData = async (body) => {
    ...
    try {
      const apiData = await createJobs(body);
      if (apiData.error) {
        setError(apiData.error);
      } else {
        getData();
  ...
  return (
    <div className={styles.DataTable}>
      <PageHeader titles={`Jobs`} active="Retailers" items={["Tables"]} />
                              ...
                              <div className="col-lg-12">
                                ...
                                <div className="mb-3">
                                  ...
                                  <input
                                    ...
                                    id="recipient-name"
                                    required
                                    placeholder="Enter Type : Full Time/ Part Time"
                                  />
                                </div>
                              </div>
                              <div className="col-lg-12">
