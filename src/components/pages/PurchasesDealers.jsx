...
import { getCustomers, getDealerPurchases } from "../../utils/api";
...
const COLUMN = [
  ...
  },
  {
    ...
    Cell: (props) => <span>{props.value ? props.value : "Pending"}</span>,
  },
];
...
const PurchasesDealers = () => {
  ...
  const getData = useCallback(async () => {
    setLoading(true);
    try {
      const apiData = await getDealerPurchases(localStorage.getItem("user_id"));
      if (apiData.error) {
  ...
  return (
    <div className={styles.DataTable}>
      <PageHeader titles="My Sales" active="Customers" items={["Tables"]} />
      <ToastContainer />
...
export default PurchasesDealers;
