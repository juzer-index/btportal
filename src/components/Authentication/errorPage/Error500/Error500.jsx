    ...
    <div className="login-img">
        ...
        <div className=''>
            <div className="page">
                ...
                {/* <!-- PAGE-CONTENT OPEN --> */}
                <div className="page-content error-page error2 text-white mt-5"  style={{marginTop:"200px"}} >
                    <div className="container text-center bg-white text-dark" style={{width:"30%"}}>
                        <div className="error-template">
                            ...
                            <div className="text-center">
                                <Link className="btn btn-secondary mt-5 mb-5" to={`${process.env.PUBLIC_URL}/`}> <i className="fa fa-long-arrow-left"></i> Back to Home </Link>
                            </div>
                        </div>
                    </div>
                </div>
