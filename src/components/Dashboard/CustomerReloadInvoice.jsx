...
import { getCustomerPurchases, getCustomers } from "../../utils/api";
...
const CustomerReloadInvoice = ({ filter, setFilter }) => {
  return (
...
const CustomerPurchases = () => {
  ...
  return (
    <div>
      <PageHeader titles="My Purchases" active="Customers" items={["Tables"]} />
      <ToastContainer />
                          ...
                          <div className="card-body">
                            <div className="d-flex">
                              <div className="text-white">
                                ...
                                <p className="text-white mb-0">{data.status}</p>
                              </div>
...
export default CustomerReloadInvoice;
